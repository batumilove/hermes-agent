...
class TestAutoTitleSession:
    ...
    def test_does_not_callback_when_title_lost_race(self):
        ...
        db.set_auto_title_if_empty.assert_called_once_with("sess-1", "Late Title")
        assert seen == []
...
class TestMaybeAutoTitle:
    ...
    def test_generates_numbered_title_on_collision(self):
        db = MagicMock()
        db.get_session_title.return_value = None
        db.set_auto_title_if_empty.side_effect = [
        ...
        assert db.set_auto_title_if_empty.call_args_list[0].args == (
            "sess-1",
