    ...
    with zipfile.ZipFile(zip_path, "r") as zf:
        ...
        for member in members:
            ...
            try:
                target.parent.mkdir(parents=True, exist_ok=True)
                with zf.open(member) as src, open(target, "wb") as dst:
                    # Stream large archive members in bounded chunks. Session
                    # databases can be multiple GiB and must not be loaded into
                    # memory as one decompressed bytes object during restore.
