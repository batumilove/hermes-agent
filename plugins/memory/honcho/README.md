...
| `honcho_conclude` | No | Write, list/search, or delete persistent conclusions (list surfaces the ids delete needs); accepts optional JSON-object `metadata` for provenance on new conclusions |
