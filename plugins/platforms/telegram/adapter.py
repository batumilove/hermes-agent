...
class TelegramAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig):
        ...
        # Approval button state: message_id → (session_key, request_id)
        self._approval_state: Dict[int, tuple[str, Optional[str]]] = {}
    ...
    async def send_exec_approval(
        ...
        try:
            ...
            # Store exact request correlation with the session routing key.
    ...
    async def _handle_callback_query(
        ...
        if data.startswith("ea:"):
            ...
            if len(parts) == 3:
                ...
                approval_ref = self._approval_state.pop(approval_id, None)
                if not approval_ref:
