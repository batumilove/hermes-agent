# Hermes Agent - Detailed Development Reference
...
This reference was split out of `AGENTS.md` so repository-scoped context loading stays below prompt truncation limits.
